...
<div class="container">
    ...
    <header id="createuser">
        <button type="submit" class="btn btn-primary" data-target="#userModal" data-toggle="modal" id="register">Add User</button>
        <button type="submit" class="btn btn-primary" data-target="#serverModal" data-toggle="modal" id="registerServer">Add Server</button>
    </header>
...
<!--       Server Registration Processor begins here... -->
    <script type="text/javascript">
        $(function(){
            $('#registerServer').click(function(e){
                ...
                if(isValid) {
                    ...
                    $.ajax({
                       type: 'POST',
                       url: 'server_registration_processor.php',
                       data: {userserverid: userserverid,
                       ...
                       success: function(data) {
                           if($.trim(data) === "1"){
                               Swal.fire({
                                ...
                                'text': "Server with that domain name already exists in the database",
                                'type': 'warning'
                               })
                           } else {                   
                               Swal.fire({
                    ...
                    Swal.fire({
                    'title': 'Failure to Register Server!',
...
<!--       Server Registration Processor End here...     -->
    
<!--       User Registration Processor begins here... -->
    <script type="text/javascript">
        $(function(){
            $('#registerUser').click(function(e){
                ...
                if(isValid) {
                    ...
                    $.ajax({
                       type: 'POST',
                       url: 'user_registration_processor.php',
                       data: {userid: userid,
                              usertype: usertype,
                              firstname: firstname, 
                              lastname: lastname,
                    ...
                    Swal.fire({
                    'title': 'Failure to Register User!',
                    'text': 'Kindly enter all the required details.',
                    'type': 'error'
                   })
                }   
