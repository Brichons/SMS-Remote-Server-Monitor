...
<!--              <button type="submit" class="btn btn-primary" data-target="#exampleModal" data-toggle="modal" id="register">Register</button>-->
    ...
    <!-- Registration Form end Here... -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="register" data-dismiss="modal">Add User</button>
      </div>
    </div>
  </div>
</div>
...
<header id="createuser">
    <button type="submit" class="btn btn-primary" data-target="#exampleModal" data-toggle="modal" id="register">Add Server</button>
</header>
<!--Table-->
<table class="table">
...
-->
    ...
    <h4 id="nouser">Add Servers here...</h4>
